  ...
  return (
    <>
      <div className="w-full  h-full flex flex-row item-start justify-between lg:gap-x-32 md:gap-x-16 sm-gap-x-8 gap-x-4">
        ...
        <div className="w-full h-auto float-start inline-block  bg-black py-1 px-3 border-t-[#1d1d1d] border-t fixed bottom-0 left-0 lg:hidden  md:hidden sm:block  z-50">
          <MobileNav />
        </div>
        <Routes >
